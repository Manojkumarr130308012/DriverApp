...
public class HistoryAdaptor extends RecyclerView.Adapter<HistoryAdaptor.ViewHolder> {
    ...
    private ArrayList<History> Model;
    private Context context;
    DBHelper dbHelper;
    String id,na,pa;


    public HistoryAdaptor(ArrayList<History> courseModalArrayList, Context context) {
...
//        }
    ...
    @Override
    public void onBindViewHolder(@NonNull HistoryAdaptor.ViewHolder holder, final int position) {
        History modal = Model.get(position);
